...
writeOGR(kml_data2, "/Users/Divij/Desktop/Geo IQ Data/Kalyan1.kml",layer="CZ",driver="KML",overwrite_layer = T) 

kml_data3 = kml_data[1901:x,]
writeOGR(kml_data3, "/Users/Divij/Desktop/Geo IQ Data/Kalyan2.kml",layer="CZ",driver="KML",overwrite_layer = T) 
